    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      ...
      <form onSubmit={handleSearch} className="mb-6 flex gap-2 items-center">
        <input
          ...
          className="flex-grow px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <Button type="submit" className="px-6 py-2">Search</Button>
      </form>

      {/* Only show 'results for' if searching */}
      {query && (
        <div className="my-6">
